...
As the main feature of the ``estimateScore`` is ''view the future results''. You can simulate the results of planned matches for your favourite team and view the changes in the table immediately.
